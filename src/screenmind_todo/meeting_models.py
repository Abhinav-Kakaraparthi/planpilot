...
class MeetingSession(Base):
    ...
    execution_health = Column(String(40), nullable=False, default="needs_start")
    next_recommendation = Column(Text, nullable=False, default="")
    adaptation_note = Column(Text, nullable=False, default="")
...
class MeetingActionItem(Base):
    ...
    dependency_summary = Column(Text, nullable=False, default="")
    risk_level = Column(String(20), nullable=False, default="medium")
    unblocker = Column(Text, nullable=False, default="")
